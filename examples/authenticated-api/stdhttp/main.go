...
import (
	...
	"github.com/SHOWROOM-inc/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/SHOWROOM-inc/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
