...
import (
	...
	"github.com/SHOWROOM-inc/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/SHOWROOM-inc/oapi-codegen/v2/examples/authenticated-api/echo/server"
)
